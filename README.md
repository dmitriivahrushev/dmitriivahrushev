...
<p align="left">Осуществляю разработку систем сбора и хранения данных с использованием современных реляционных и нереляционных СУБД. Занимаюсь созданием ETL (Extract Transform Load) и ELT (Extract Load Transform) сценариев, применяя SQL и Python. Активно использую инструменты автоматизации и оркестрации задач, такие как Airflow, пишу DAG (Directed Acyclic Graph) для оркестрации процессов. Применяю систему контроля версий Git. Также занимаюсь развертыванием и настройкой необходимых сервисов в Docker.
</p>
<br>
